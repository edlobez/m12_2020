 ...
 */
@Repository
@Component("personaImp")
public class PersonaImp extends MyRepositoryImp <Persona> implements MyRepository <Persona>{

    @Override
    protected Persona buildDomainFromResultSet(ResultSet rs) throws SQLException {
       return new Persona ( 
               rs.getInt("idpersona"),
               rs.getString("nom"),
